package com.codersoft.cms.wechat.mp.aop;
...
public class ControllerLogAspect {
    ...
    @Pointcut("within(com.codersoft.cms.wechat.mp..*.controller..*)")
    public void inController() {
    }

    @Pointcut("execution(public * com.codersoft.cms.wechat.mp..*.controller..*.*(..))")
