...
layui.define(["element","jquery"],function(exports){
    ...
    $.ajax({
        url : '/admin/permission/directoryList',
        type : 'GET',
        async: false,
    ...
    function topNavBar(data){
        ...
        if(topMenuContext == null || topMenuContext.length == 0 ){
            ...
            $.each(pdata,function(index,item){
                if(index == 0){
                    ulHtml += '<li class="layui-nav-item layui-this" data-pid="'+item.id+'">';
                    leftNavBar(item.id);
                }else{
                    ulHtml += '<li class="layui-nav-item" data-pid="'+item.id+'">';
                }
                ...
                if(data != "" ){
                    var pdata = $.parseJSON(data);
                        ...
                        $.each(pdata,function(index,item){
                            ...
                            if(item.menuPermissionDtoList != null ){
